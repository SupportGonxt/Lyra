...
### AXIS · Operations
1. Document extraction from an uploaded file — the vision path exists in the API; the web screen demands pasted text.
...
4. Screens for NTU / lapse / reinstate and SLA prediction (API exists).
