...
export const ar: Messages = {
  ...
  "nav.memory/export": "خزنة الملاحظات",
  "nav.admin/audit-export": "تصدير سجل التدقيق",
  "nav.admin/ai/analytics": "تحليلات الذكاء الاصطناعي",
  "nav.analytics/builder": "منشئ التقارير",
  ...
  "common.search": "بحث",
  "search.open": "ابحث",
  // Record memory (ADR-0089): components/memory-panel.tsx.
  "memory.title": "الذاكرة",
  "memory.loading": "جارٍ تحميل الذاكرة",
  "memory.tab.note": "ملاحظة",
  "memory.tab.links": "مرتبط من",
  "memory.tab.graph": "الشبكة",
  "memory.tab.ai": "ذاكرة الذكاء الاصطناعي",
  "memory.note.empty": "لا توجد ملاحظة على هذا السجل بعد. الملاحظات مشتركة مع كل من يستطيع فتحه.",
  "memory.note.edit": "تحرير الملاحظة",
  "memory.note.write": "اكتب ملاحظة",
  "memory.note.label": "الملاحظة (Markdown)",
  "memory.note.hint": "اكتب [[ ثم اسمًا لربط سجل آخر.",
  "memory.note.save": "حفظ الملاحظة",
  "memory.note.cancel": "إلغاء",
  "memory.note.edited": "آخر تعديل",
  "memory.note.unnamed": "سجل لا يمكنك فتحه",
  "memory.note.conflict": "حفظ شخص آخر هذه الملاحظة بعد أن فتحتها. نصك ما زال هنا — انسخه، ثم أعد التحميل لرؤية نسخته، ثم احفظ مرة أخرى.",
  "memory.note.reload": "إعادة التحميل",
  "memory.note.failed": "لم تُحفظ الملاحظة.",
  "memory.picker.label": "سجلات للربط",
  "memory.picker.prompt": "واصل كتابة الاسم للعثور على سجل",
  "memory.picker.none": "لا يوجد سجل مطابق",
  "memory.links.empty": "لا توجد ملاحظة لسجل آخر ترتبط بهذا السجل بعد.",
  "memory.graph.label": "السجلات المرتبطة بهذا السجل أو منه",
  "memory.graph.hops": "مدى البحث",
  "memory.graph.depth1": "قفزة واحدة",
  "memory.graph.depth2": "قفزتان",
  "memory.graph.empty": "لا شيء مرتبط بهذا السجل أو منه بعد.",
  "memory.graph.truncated": "يُعرض أقرب {count} سجلًا.",
  "memory.ai.empty": "لا تحتفظ المنصة بأي ذاكرة عن هذا السجل.",
  "memory.ai.why": "مُستذكَر من {provenance}. يمكن استخدامه في: {purposes}. الحساسية: {sensitivity}.",
  "memory.ai.unbound": "لا شيء بعد (لم يُحدَّد غرض)",
  "memory.ai.provenance": "المصدر",
  "memory.ai.expires": "ينتهي في",
  "memory.ai.noExpiry": "بلا انتهاء",
  "memory.ai.forget": "انسَ",
  "memory.ai.forgetConfirm": "نسيان هذه الذاكرة؟ تتوقف المنصة عن استخدامها فورًا، ولا يمكن استعادتها.",
  ...
  "common.bulk.action": "مع المحدَّد",
  "common.bulk.apply": "تطبيق على المحدَّد",
  "common.bulk.select": "تحديد {name}",
  ...
  "common.import.submit": "استيراد",
  "common.import.empty": "الملف فارغ. اختر ملف CSV فيه سطر عناوين وصف واحد على الأقل.",
  "common.import.done": "أُنشئ {created}. موجود مسبقًا: {skipped}. مرفوض: {refused}.",
  "common.import.line": "السطر {line}",
  "common.open": "فتح",
  ...
  "common.rule.join": "المطابقة",
  "common.rule.join.all": "كل من يطابق جميع هذه الشروط",
  "common.rule.join.any": "كل من يطابق أيًّا من هذه الشروط",
  "common.rule.what": "الشرط",
  "common.rule.what.none": "بلا شرط",
  "common.rule.what.tag": "موسوم بـ",
  "common.rule.what.reason": "سبب العميل المرتقب",
  "common.rule.what.score": "درجة العميل المرتقب لا تقل عن",
  "common.rule.value": "القيمة",
