...
// ADR-0085, docs/16 H11: a record's memory, Obsidian-shaped. Four views over
...
export function MemoryView(props: MemoryViewProps) {
  ...
  return (
    <section aria-labelledby="memory-title" className="flex flex-col gap-2 rounded-lg border border-border bg-surface-1 p-4">
      <h2 id="memory-title" className="font-ui text-12 font-medium uppercase tracking-[0.14em] text-subtle">
        {t("memory.title")}
      </h2>
