          ...
          {ds ? (
            <>
              <fieldset className="flex flex-col gap-2">
                <legend className="mb-1 font-ui text-12 font-medium uppercase tracking-[0.14em] text-subtle">{l("metrics")}</legend>
                {ds.metrics.map((m) => (
              ...
              {ds.dimensions.length ? (
                <fieldset className="flex flex-col gap-2">
                  <legend className="mb-1 font-ui text-12 font-medium uppercase tracking-[0.14em] text-subtle">{l("dimensions")}</legend>
                  {ds.dimensions.map((d) => (
                    <Checkbox
                      key={d.key}
                      name="dimension"
              ...
              {ds.dimensions.length ? (
                <fieldset className="flex flex-col gap-3">
                  <legend className="mb-1 font-ui text-12 font-medium uppercase tracking-[0.14em] text-subtle">{l("filters")}</legend>
                  {filterRows.map((f, i) => (
