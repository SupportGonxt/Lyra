...
tab, ADR-0087). Eleven definitions over the five AI datasets (`aiRuns`,
...
ADR-0087). The first web reader of `GET /v1/analytics/datasets`: dataset →
...
**Ask in words** (same screen, docs/15 §4.6 + §4.7, ADR-0087). One input posts
