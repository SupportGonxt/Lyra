...
export const ar: Messages = {
  ...
  "journey.north.title": "رؤية منقولة من AXIS",
  "journey.north.empty": "لا يوجد موجز بعد",
  "journey.north.continue": "اطّلع على الفراغ السوقي في SCOUT",
  "journey.scout.title": "الفراغ السوقي، منقول من NORTH",
  "journey.scout.empty": "لا يوجد فراغ سوقي بعد",
  "journey.scout.continue": "صِغ حملة SIGNAL",
  "journey.signal.title": "حملة منقولة من SCOUT",
  ...
  "common.search": "بحث",
  "search.open": "ابحث",
  // Record memory (ADR-0085): components/memory-panel.tsx.
