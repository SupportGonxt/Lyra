...
// ADR-0085. The smallest markdown a record note needs — headings, paragraphs,
      ...
      {blocks(source).map((block, b) => {
        ...
        switch (block.kind) {
          case "heading": {
            ...
            return (
              <Tag key={key} className={block.level <= 2 ? "font-serif text-16 text-text" : "font-ui text-13 font-medium text-text"}>
